...
app.use(cors({
    origin: ["http://localhost:5173", "http://localhost:5174", "http://localhost:5175", "http://localhost:5176", "http://localhost:5180", "http://localhost:3000", "https://wellfire-frontend.onrender.com"],
    credentials: true
}));
