...
const AboutPreview = ({ showViewMore = true }) => {
    ...
    return ( <
        ...
        { /* Background Overlay */ } <
        div className = "absolute inset-0 bg-black/70" / > { /* Background Film Grain Effect */ } <
        ...
        { /* LEFT SIDE - Heading */ } <
        div className = "w-full lg:w-1/2 flex flex-col justify-center space-y-4 lg:space-y-10 py-0 text-center lg:text-left order-1 lg:order-1 mt-4 lg:mt-0" > { /* Synopsis Label */ } <
        motion.div variants = { itemVariants }
        className = "flex justify-center lg:justify-start" >
        <
        span className = "inline-block text-4xl sm:text-7xl tracking-[0.2em] text-amber-100 py-2 lg:py-10 lg:pt-2 uppercase relative"
        style = {
        ...
        { /* View More Button - Only show if showViewMore is true */ } {
            showViewMore && ( <
                motion.div variants = { itemVariants }
                className = "flex justify-center lg:justify-start pt-1 lg:pt-4 py-4 lg:pt-6" >
                <
                motion.button onClick = { handleReadMore }
                whileHover = {
                    {
                        scale: 1.05,
                ...
                svg className = "w-4 h-4 relative z-10 transition-transform duration-300 group-hover:translate-x-1"
                fill = "none"
                stroke = "currentColor"
                viewBox = "0 0 24 24" >
                <
        ...
        div className = "w-full lg:w-1/2 flex flex-col justify-center space-y-6 lg:space-y-8 text-center lg:text-left order-2 lg:order-2" > { /* Description */ } <
        motion.div variants = { itemVariants }
        className = "max-w-xl mx-auto lg:mx-0" >
        <
        p className = "text-xs sm:text-sm lg:text-base text-gray-300 leading-relaxed font-light tracking-wide"
        style = {
            { fontFamily: "'Inter', sans-serif" } } >
        ...
        className = "grid grid-cols-2 gap-4 lg:gap-6 mt-2 lg:mt-8" >
        {
            stats.map((stat, index) => ( <
                ...
                { /* Animated number */ } <
                div className = "text-2xl lg:text-3xl font-bold text-amber-400 mb-0.5 lg:mb-2 transition-all duration-500 group-hover:text-amber-300 group-hover:scale-110" > { animatedStats[index] } { stat.suffix } <
                /div> { /* Label */ } <
                div className = "text-xs lg:text-sm text-gray-300 font-medium uppercase tracking-wider transition-all duration-500 group-hover:text-white group-hover:tracking-wider" > { stat.label } <
                /div> <
                /motion.div>
            ))
        } <
        ...
        className = "max-w-xl mx-auto lg:mx-0" >
        <
        p className = "text-xs sm:text-sm lg:text-base text-gray-300 leading-relaxed font-light tracking-wide italic"
        style = {
            { fontFamily: "'Inter', sans-serif" } } >
        We combine youthful energy with technical excellence to deliver work that is fresh, impactful, and ready
        for the world. <
        /p> <
        /motion.div>
        ...
        { /* Read More Button */ } <
        motion.div variants = { itemVariants }
        className = "flex justify-center lg:justify-start pt-2 lg:pt-4" >
