    ...
    return (
      ...
      >
        <div className="relative w-full h-full group overflow-hidden" style={{ margin: 0, padding: 0, border: 'none', borderRadius: 0 }}>
          ...
          {/* YouTube Video Title - Moved below video for mobile */}
          {product.youtubeLink && !isMobile && (
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-2 sm:p-3 z-30">
              <h3 
                className="text-red-500 text-sm sm:text-base font-bold uppercase tracking-wider leading-tight mb-1"
                style={{
          ...
          {/* Mobile: Show title at bottom in one line */}
          {product.youtubeLink && isMobile && (
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-2 z-30">
  ...
  const ProductVideoCard = ({ product, className = "", isYouTubeThumbnail = false }) => (
    ...
    >
      <div className="relative w-full h-full group overflow-hidden">
        ...
        {/* YouTube Video Title Overlay for Right Side Videos */}
        {product.youtubeLink && (
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-1.5 sm:p-2 z-30 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <h4 
              ...
              <>
                ...
                <div className="w-full h-2/3 overflow-hidden flex flex-col p-1 gap-1">
                  {categoryProducts.length > 2 ? (
                    ...
                    >
                      <p
                        className="text-red text-xs text-center px-3 py-2"
                        style={{
                          fontFamily: "Montserrat, sans-serif",
                          fontWeight: "500",
                        }}
